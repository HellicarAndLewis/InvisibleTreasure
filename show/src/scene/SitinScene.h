...
public:
    ...
    struct HitArea {
        ...
        void set(string name, ofVec2f position=ofVec2f(.5, .5), float size=.01) {
            ...
            group.add(this->lightingCueIn.set("light in", 0, -1, 100));
            
            group.add(this->lightingCueOut.set("light out", 0, -1, 100));
        ...
        ofParameter<int> lightingCueIn;
        
        ofParameter<int> lightingCueOut;
