...
../../../show.app/Contents/MacOS/show --args  -mode="WINDOW" -id=4 -windowId=3 -width=1024 -height=768 -fullScreen=true -logLevel=3 -logToFile=true -appendToLog=true
