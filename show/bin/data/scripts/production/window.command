...
../../../show.app/Contents/MacOS/show --args  -mode="WINDOW" -id=2 -windowId=1 -width=1024 -height=768 -fullScreen=true -logLevel=3 -logToFile=true -appendToLog=true
