...
../../../show.app/Contents/MacOS/show --args  -mode="WINDOW" -id=3 -windowId=2 -width=1024 -height=768 -fullScreen=true -logLevel=3 -logToFile=true -appendToLog=true
